<div class="dialog" id="introduction-dialog" style="display: none">
    ...
    <!-- main dialog -->
    <h1>Welcome to Weby.io - best place to create and share your content</h1>

    <p>
        Experience the new way of creating something beautiful - from content collections, family albums, birthday party
        invitations, to band and celebrity fan pages - Weby.io is a fun and exciting new ways to mash and share what is
        important to you.
    </p>
    <p>
        With Weby.io fun never stops - you decide what you want to create and share with your friends and the rest of
        the world.
    </p>
    <p>
