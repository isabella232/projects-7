...
<script type="weby/tpl" id="weby-details-tpl">
    <div class="weby-details" id="weby-details">
        <div class="details-arrow">
            ...
            #if (data.tags.length > 0) {#<a class="shown" data-role="show-full-details" href="javascript:void(0);"></a>#}#
        </div>
        ...
        <div class="full-weby-data">
            <div class="flip-front">
                <div class="user-info">
                    ...
                    <div>
                        <a href="#= WEB+'user/'+ data.webyUser.name #">
                            <span class="user-photo" #if (data.webyUser.avatar != '') {# style="background: url(#= data.webyUser.avatar #) top left; background-size: cover" #}#></span>
                        </a>
                        <p class="user-name" #if (data.webyUser.name.length > 14) {# data-role="weby-user" data-tooltip="#= data.webyUser.name #" class="has-tooltip-top" #}#>
                        #if (data.webyUser.name.length > 14) {# #= data.webyUser.name.substring(0, 14) #... #} else {# #= data.webyUser.name# #}#</p>
                        <p class="user-name"><b class="followers-count">#= data.webyUser.followers #</b> followers</p>
                    </div>
                ...
                <div class="favorited-by" #if (data.favoriteCount==0) {# style="display:none" #}#>
                    <h2>Favorited by</h2>
                    <ul>
                        #for(var i in data.favoritedBy){#
                        <li class="has-tooltip-top" data-tooltip="#= data.favoritedBy[i].username #">
                            <a class="photo" href="#= WEB+'user/'+data.favoritedBy[i].username #"><img src="#= data.favoritedBy[i].avatarUrl #"/></a>
                        </li>
                        #}#
                    </ul>
                ...
                <div class="tags flip-behind" #if (data.tags.length == 0){# style="display: none" #}#>
                    <h2>
                        Tags
                    </h2>
                    #for(var i in data.tags){#
                        <a href="#= WEB+'tag/'+data.tags[i].slug #"><span class="weby-tag-blue">
                        #if(data.tags[i].tag.length > 14){# #= data.tags[i].tag.substring(0, 10) #... #}else{# #= data.tags[i].tag # #}#
                        </span></a>
