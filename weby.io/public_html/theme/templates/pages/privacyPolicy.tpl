...
{block name="content"}
    <div class="static-container">
        ...
        <p>When ordering or registering on our site, as appropriate, you may be asked to enter your: name,
            e-mail address, mailing address or phone number, company name, VAT ID, physical address and whatever
            information is required to complete the action. You may, however, visit our site anonymously.</p>
        ...
        <p>We implement a variety of security measures to maintain the safety of your personal information when you
            place
            an order or enter, submit, or access your personal information. However, we do not collect any financial
            information such as credit card number for online payments and we use third-party provider to process those
            payments.</p>

        <p>We may collect bank account information (IBAN, SWIFT) in case of refund.</p>
        ...
        <p>
            <a href="mailto:info@weby.io">info@weby.io</a>
        </p>
    </div>
{/block}